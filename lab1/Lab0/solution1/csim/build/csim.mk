...
HLS_SOURCES = ../../../tb_demo.cpp ../../../demo.cpp
...
$(ObjDir)/tb_demo.o: ../../../tb_demo.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../tb_demo.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_demo.d

$(ObjDir)/demo.o: ../../../demo.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../demo.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
