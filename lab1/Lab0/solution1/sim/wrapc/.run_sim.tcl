...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "simpleALU.autotvin.dat"
	set constFileTvOut       "simpleALU.autotvout.dat"
	set constFileHdlTvIn     "simpleALU.autohdltvin.dat"
	set constFileHdlTvOut    "simpleALU.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
