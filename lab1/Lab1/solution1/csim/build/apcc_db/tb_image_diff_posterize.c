...
void image_diff_posterize( char (*)[256],  char (*)[256],  char (*)[256]);
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @image_diff_posterize([256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.A, i64 0, i64 0), [256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.B, i64 0, i64 0), [256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.C_hw, i64 0, i64 0)) nounwind, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_329_count);
   /*tail*/ image_diff_posterize(((&aesl_internal_main_OC_A[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 256
#endif
])), ((&aesl_internal_main_OC_B[(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @image_diff_posterize([256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.A, i64 0, i64 0), [256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.B, i64 0, i64 0), [256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.C_hw, i64 0, i64 0)) nounwind, !dbg !19 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_543_count);
   /*tail*/ image_diff_posterize(((&aesl_internal_main_OC_A[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 256
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @image_diff_posterize([256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.A, i64 0, i64 0), [256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.B, i64 0, i64 0), [256 x i8]* getelementptr inbounds ([256 x [256 x i8]]* @aesl_internal_main.C_hw, i64 0, i64 0)) nounwind, !dbg !20 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_870_count);
   /*tail*/ image_diff_posterize(((&aesl_internal_main_OC_A[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 256
#endif
