...
$(ObjDir)/tb_image_diff_posterize.c_pre.c.tb.o : tb_image_diff_posterize.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) tb_image_diff_posterize.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/image_diff_posterize.c_pre.c.tb.o : image_diff_posterize.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) image_diff_posterize.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
