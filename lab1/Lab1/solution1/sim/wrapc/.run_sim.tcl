...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "image_diff_posterize.autotvin.dat"
	set constFileTvOut       "image_diff_posterize.autotvout.dat"
	set constFileHdlTvIn     "image_diff_posterize.autohdltvin.dat"
	set constFileHdlTvOut    "image_diff_posterize.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
