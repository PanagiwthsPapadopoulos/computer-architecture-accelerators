...
// ==============================================================
# 1 "C:/Users/Stavros/AppData/Roaming/Xilinx/Vitis/image_diff_posterize.c"
# 1 "C:/Users/Stavros/AppData/Roaming/Xilinx/Vitis/image_diff_posterize.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Stavros/AppData/Roaming/Xilinx/Vitis/image_diff_posterize.c" 2
...
# 2 "C:/Users/Stavros/AppData/Roaming/Xilinx/Vitis/image_diff_posterize.c" 2
...
# 3 "C:/Users/Stavros/AppData/Roaming/Xilinx/Vitis/image_diff_posterize.c" 2
...
int j;
    Row_Loop: for (int i = 0; i < (1 << 8); i++) {
#pragma HLS LOOP_TRIPCOUNT min=HEIGHT max=HEIGHT

 Col_Loop: for (j = 0; j < (1 << 8); j++) {
#pragma HLS LOOP_TRIPCOUNT min=WIDTH max=WIDTH
#pragma HLS PIPELINE II=1
 pixel_t pixelA = A[i][j];
            pixel_t pixelB = B[i][j];
            int16_t diff_temp = (int16_t)pixelA - (int16_t)pixelB;
...
extern "C"
#endif
void apatb_image_diff_posterize_ir(unsigned char (*)[256], unsigned char (*)[256], unsigned char (*)[256]);
#ifdef __cplusplus
extern "C"
#endif
void image_diff_posterize_hw_stub(unsigned char (*A)[256], unsigned char (*B)[256], unsigned char (*C)[256]){
...
extern "C"
#endif
void apatb_image_diff_posterize_sw(unsigned char (*A)[256], unsigned char (*B)[256], unsigned char (*C)[256]){
apatb_image_diff_posterize_ir(A, B, C);
return ;
}
#endif
# 46 "C:/Users/Stavros/AppData/Roaming/Xilinx/Vitis/image_diff_posterize.c"
